...
if (window.location.pathname.includes('article.html')) {
    document.addEventListener('DOMContentLoaded', async () => {
        try {
            ...
            showNotification('Failed to load article. Please try again later.', 'error');
        }
    });
}
...
function renderArticle(article) {
    ...
    // Update page title
    document.title = `${article.title} - FinRise`;
...
function initCommentForm(articleId) {
    ...
    commentForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showNotification('Failed to add comment. Please try again later.', 'error');
        }
    });
}
...
if (window.location.pathname.includes('writer-dashboard.html')) {
    document.addEventListener('DOMContentLoaded', async () => {
        try {
            ...
            showNotification('Failed to load writer dashboard. Please try again later.', 'error');
        }
    });
}
        ...
        button.addEventListener('click', async (e) => {
            ...
            if (confirm('Are you sure you want to delete this article?')) {
                try {
                    ...
                    showNotification('Failed to delete article. Please try again later.', 'error');
                }
            }
        });
    });
...
function initArticleEditor(userId) {
    ...
    newEditorForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showNotification('Failed to save article. Please try again later.', 'error');
        }
    });
}
...
async function loadArticleForEditing(articleId) {
    try {
        ...
        if (editorForm) {
            ...
            // Update editor title
            document.querySelector('.dashboard-section-title').textContent = 'Edit Article';
            
            // Update submit button
            document.querySelector('#editor-form button[type="submit"]').textContent = 'Update Article';
        }
    } catch (error) {
